INSERT INTO public.lugar (codigo, nombre, tipo) 
VALUES
(1, 'Amazonas', 'Estado'),
(2, 'Anzoátegui', 'Estado'),
(3, 'Apure', 'Estado'),
...
INSERT INTO public.lugar (codigo, nombre, tipo, fk_lugar) 
VALUES
...
INSERT INTO lugar (codigo, nombre, tipo, fk_lugar) VALUES
...
INSERT INTO personacontacto(nombre, apellido, cedula)
Values ('Raul', 'Gomez', 28998776),
       ('Jesus', 'Mochima', 28345576),
       ('Daniella', 'Russeu', 12987654),
       ('Jack', 'Chepper', 10987654),
       ('Kate', 'Austen', 11233454);

INSERT INTO cliente(cedula, nombre, apellido, fecha_nac, estado_civil, empresa, l_vip, fk_lugar)
Values (26605119, 'Victor', 'Garcia', '01-09-1998', 'Soltero','PDVSA', 'No', '212'),
       (25417894, 'Amelia', 'Brito', '17-04-1997', 'Soltero', 'GOOGLE', 'No', '212'),
       (25228976, 'Manuel', 'Correia', '07-01-1997', 'Soltero','SUPRA', 'Si', '215'),
       (12345678, 'Ralph', 'Dybnie', '06-09-1980', 'Casado', 'STARLAB', 'Si', '220'),
       (98765987, 'Maria', 'Rios', '04-04-1765', 'Casado', 'EPA', 'No', '170');

INSERT INTO sucursal(nombre, capacidad, email, capacidad_almacenamiento, fk_lugar, fk_personacontacto)
Values ('LogUCAB 2015', 123, 'logucab2015@ucab.edu.ve', 982 ,312 , 1),
       ('Sislog 223', 234 , 'Sislog223@ucab.edu.ve', '947', 200, 2),
       ('LogUCAB III', 938 , 'logUCABIII@ucab.edu.ve', 9872 , 212 , 3),
       ('RapidLOG', 983 , 'rapidlog@ucab.edu.ve', 2345 , 210, 4),
       ('UCABlog', 2355 , 'UCABlog@ucab.edu.ve', 3455 , 224 , 5);